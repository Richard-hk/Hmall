...
：</dt>
        ...
        <form name=traderefund action=admin/Order/returnMoney method=post target="_blank">
            <div id="body3" class="tab-content" name="divcontent">
                <dl class="content">
                    <dt>商户订单号
：</dt>
                    <dd>
                        <input id="WIDTRout_trade_no" name="order_id" />
                    </dd>
                    <hr class="one_line">
                    <dt>支付宝交易号
：</dt>
                    <dd>
                        <input id="WIDTRtrade_no" name="alipay_id" />
                    </dd>
                    <hr class="one_line">
                    <dt>退款金额
：</dt>
